...
uint8_t memRead8 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_RAM:
		return BaseRAM[address - region.hardwareAddress];
	}
	return 0;
}
...
uint16_t memRead16 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_RAM:
		return *(uint16_t*)(&BaseRAM[address - region.hardwareAddress]);
	}
	return 0;
}
...
uint32_t memRead32 (RegionType regionType, HWAddressType address)
{
	...
	{
	case MEMVIEW_RAM:
		return *(uint32_t*)(&BaseRAM[address - region.hardwareAddress]);
	}
	return 0;
}
...
void memWrite8 (RegionType regionType, HWAddressType address, uint8_t value)
{
	...
	{
	case MEMVIEW_RAM:
		BaseRAM[address - region.hardwareAddress] = value;
		break;
	}
}
...
void memWrite16 (RegionType regionType, HWAddressType address, uint16_t value)
{
	...
	{
	case MEMVIEW_RAM:
		*(uint16_t*)(&BaseRAM[address - region.hardwareAddress]) = value;
		break;
	}
}
...
void memWrite32 (RegionType regionType, HWAddressType address, uint32_t value)
{
	...
	{
	case MEMVIEW_RAM:
		*(uint32_t*)(&BaseRAM[address - region.hardwareAddress]) = value;
		break;
	}
}
